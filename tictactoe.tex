...
\begin{document}
	...
	\begin{homeworkProblem}[Part 6]
		...
		From the graph, we can see that the  win rate improved from around 63\% to around 94\%. Meanwhile, the lose rate and tie rate decreased from around 20\% to 5\%. This shows that the agents has learned to make moves that rewards it for winning the game.
